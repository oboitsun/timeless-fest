  ...
  return (
    <div className="w-full flex flex-col gap-5 xl:gap-10">
      <motion.div
        ...
        <Image
          fill
          src={photo.fields.file.url?.replace(
        ...
        <motion.p
          ...
          className={`text-2xl lg:text-4xl xl:text-6xl font-matiz uppercase text-white absolute top-1/2 left-1/2 leading-none w-max`}>
          {title}
        </motion.p>
      </motion.div>
      {tiers.map((tier, i) => (
